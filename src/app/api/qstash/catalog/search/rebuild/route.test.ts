...
describe('POST /api/qstash/catalog/search/rebuild', () => {
  it('verifies the QStash signature and processes Product Search rebuild work', async () => {
    ...
    const response = await POST(
      new Request(
        'https://store.example.com/api/qstash/catalog/search/rebuild',
        {
